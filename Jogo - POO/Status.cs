...
namespace Jogo___POO
{
    class Status
    {
        ...
        public Status()
        {
            this.forca = Convert.ToDouble(random.Next(10,51));
            this.defesa = Convert.ToDouble(random.Next(10, 51));
            this.agilidade = Convert.ToDouble(random.Next(10, 51));
            this.sorte = Convert.ToDouble(random.Next(10, 51));
            this.inteligencia = Convert.ToDouble(random.Next(10, 51));
            this.manaMax = Convert.ToDouble(random.Next(10, 51));
            this.vidaMax = Convert.ToDouble(random.Next(10, 51));
